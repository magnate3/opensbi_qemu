...
static int c910_console_init(void)
{
#if 0
#define C910_UART_ADDR                 0xfff73000
#define C910_UART_FREQUENCY            50000000
#else
#define C910_UART_ADDR                 0x1fba4000
#define C910_UART_FREQUENCY            30000000
#endif
#define C910_UART_BAUDRATE             115200
#define C910_UART_REG_SHIFT            2
#define C910_UART_REG_WIDTH            4
	return uart8250_init(C910_UART_ADDR,
				C910_UART_FREQUENCY,
				C910_UART_BAUDRATE,
				C910_UART_REG_SHIFT,
				C910_UART_REG_WIDTH);
...
const struct sbi_platform_operations platform_ops = {
	...
	.console_init        = c910_console_init,
